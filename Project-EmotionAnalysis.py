...
if option == 'Outdoor View':
    ...
    if option == 'Indoor View':
        ...
        cam = cv2.VideoCapture("/content/drive/MyDrive/Colab Notebooks/Project-Emotion Analysis/ThePerfectWalk.mp4")
        cam.set(cv2.CAP_PROP_FPS, 1)
...
protoFile = "/content/drive/MyDrive/Colab Notebooks/Project-Emotion Analysis/pose_deploy_linevec.prototxt"
weightsFile = "/content/drive/MyDrive/Colab Notebooks/Project-Emotion Analysis/pose_iter_440000.caffemodel"
nPoints = 18
# COCO Output Format
...
args = {
    'model': '/content/drive/MyDrive/Colab Notebooks/Project-Emotion Analysis/resnet-34_kinetics.onnx',
    'classes': '/content/drive/MyDrive/Colab Notebooks/Project-Emotion Analysis/action_recognition_kinetics.txt'
    }
